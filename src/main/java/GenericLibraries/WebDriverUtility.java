...
public class WebDriverUtility {
 ...
 /**
  * This element is used to perform drag & drop of an element
  * @param source
  * @param target
  */
 ...
 /**
  * This element is used to select an element from drop down based on index
  * @param element
  * @param index
  */
 ...
 /**
  * This element is used to select an element from drop down based on visible text
  * @param element
  * @param index
  */
 ...
 /**
  * This method is is used to take ss of the webpage 
  */
 ...
 /**
  * This method is used to close the currentTab
  */
